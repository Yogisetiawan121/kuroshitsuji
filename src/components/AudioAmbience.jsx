...
export default function AudioAmbience({ isMuted }) {
  ...
  useEffect(() => {
    ...
    // The user's click on the Volume button provides the required user-gesture context
    ...
    <>
      ...
      {!isMuted && !error && (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-40 pointer-events-none select-none">
          <div className="flex items-center space-x-3 px-4 py-1.5 bg-[#0A0A0A]/80 border border-[#8B0000]/40 rounded-none">
